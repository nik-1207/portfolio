...
export default function sidebar() {
  return (
    <div className="p-2">
      <Image src={profileImg} width='250px' height='250px'  className="w-32 h-32 mx-auto rounded-full" />
      <h1 className="p-1 my-4 text-2xl font-medium tracking-wider">
        <span className="text-green-800 font-kushan">Nikhil</span> Kashyap
      </h1>
      ...
      <div className="py-4 my-4 bg-gray-200 rounded-2xl">
      ...
      <button
        ...
        onClick={() => {
          window.open("mailto:nmknikhilkashyap@gmail.com");
        }}
      >
        Email Me !
      </button>
